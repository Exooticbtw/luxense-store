...
export default function ComparisonTable() {
  const comparisonRows = Array.isArray(COMPARISON_ROWS)
    ? COMPARISON_ROWS.map((row) => ({
        feature: row?.feature ?? row?.[0] ?? "",
        luxense: row?.luxense ?? row?.[1] ?? "",
        standard: row?.standard ?? row?.[2] ?? "",
        ...
        >
          <div style={{ maxWidth: 760 }}>
            ...
            <h2 className="serif section-title" style={{ fontSize: "clamp(40px, 4vw, 58px)", maxWidth: 760 }}>
              Why MotionGlow™ feels more refined.
            </h2>
          ...
          <div className="compare-table-shell" style={{ marginTop: 28 }}>
            <div
              ...
              style={{
                ...
                boxShadow: "0 20px 44px rgba(17,17,17,.06)",
              }}
            >
              <div
                ...
                {comparisonRows.map((row, index) => (
                  <div
                    ...
                    style={{
                      ...
                      gap: 0,
                      padding: "18px 22px",
                      borderBottom: index < comparisonRows.length - 1 ? "1px solid rgba(17,17,17,.06)" : "none",
                      background: index % 2 ? "rgba(17,17,17,.012)" : "transparent",
                      alignItems: "center",
                    }}
                  >
                    ...
                    <div style={{ padding: "0 12px" }}>
                      <div
                        style={{
                          borderRadius: 18,
                          padding: "12px 14px",
                          background: "linear-gradient(180deg, rgba(201,164,106,.14), rgba(255,255,255,.94))",
              ...
              >
                <div
                  style={{
                    ...
                    background: "linear-gradient(180deg, rgba(17,17,17,.03), rgba(255,255,255,.8))",
                ...
                <div style={{ display: "grid" }}>
                  <div
                    style={{
                      padding: 16,
                      borderBottom: "1px solid rgba(17,17,17,.06)",
                      background: "linear-gradient(180deg, rgba(201,164,106,.10), rgba(255,255,255,.95))",
                    }}
                  >
